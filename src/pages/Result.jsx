      ...
      <div className={styles.inner}>
        ...
        <section className={styles.section} style={{ animationDelay: '180ms' }}>
          ...
          <div className={styles.painList}>
            {criticalIds.map(id => {
              const [dor, caminho, tensao] = DIMS_DATA[id].pain.split('\n\n')
              return (
                <div key={id} className={styles.painCard}>
                  <p className={styles.painDim}>{DIMS_DATA[id].label}</p>
                  <span className={styles.painLabel + ' ' + styles.painLabelDor}>O problema</span>
                  <p className={styles.painText}>{dor}</p>
                  <span className={styles.painLabel + ' ' + styles.painLabelSol}>O caminho</span>
                  <p className={styles.painText}>{caminho}</p>
                  <span className={styles.painLabel + ' ' + styles.painLabelTens}>Na prática</span>
                  <p className={styles.painText}>{tensao}</p>
                  <button className={styles.painHook} onClick={scrollToContact} type="button">
                    {DIMS_DATA[id].hook} →
                  </button>
                </div>
              )
        ...
        {/* CTA */}
        <section id="contato" className={styles.ctaBox} style={{ animationDelay: '260ms' }}>
